<?php
/**
 * Template Name: Caraya Homepage RY
 *
	...
	<div id="home-page-featured">
		...
		<?php if ( 'grid' == fundify_theme_mod( 'hero_style' ) ) : ?>
			...
			<ul>
				...
				<li class="sss"><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail(); ?></a></li>
				<?php endwhile; ?>
				...
				<?php shuffle( $featured->posts ); ?>	
				<?php while ( $featured->have_posts() ) : $featured->the_post(); ?>
				<li class=""><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail(); ?></a></li>
				<?php endwhile; ?>

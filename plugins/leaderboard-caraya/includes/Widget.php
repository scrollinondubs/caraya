...
class Widget extends \WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			'description' => esc_html__( 'WP Reactivate Leader Board.', $this->plugin_slug ),
		);

		parent::__construct( 'wpr-widget', esc_html__( 'Leaderboard Caraya', $this->plugin_slug ), $widget_ops );
	}

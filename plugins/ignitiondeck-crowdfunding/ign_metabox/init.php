...
class ign_cmb_Meta_Box {
	...
	function show() {
		...
		echo '<ul class="form-table cmb_metabox ignitiondeck">';
...
*/
				...
				break;
				case 'headline1':
					echo '<h4 class="ign_projectmeta_title">'.__('Project Reward Levels', 'ignitiondeck').'</h4>'; 
				break;
				case 'headline2':
					echo '<h4 class="ign_projectmeta_title">'.__('Additional Project Information', 'ignitiondeck').'</h4>'; 
				break;
				case 'headline2':
					echo '<h4 class="ign_projectmeta_title">'.__('Additional Project Information', 'ignitiondeck').'</h4>'; 
				break;
